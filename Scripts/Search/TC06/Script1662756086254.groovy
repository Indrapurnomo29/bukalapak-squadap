...
WebUI.setText(findTestObject('MainPage/Search_Input'), 'sepatu')

WebUI.click(findTestObject('MainPage/Icon_Search_Menu'))

WebUI.verifyElementPresent(findTestObject('MainPage/Sepatu_Verify'), 0)
