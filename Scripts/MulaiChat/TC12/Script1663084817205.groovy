...
WebUI.setText(findTestObject('MainPage/Cari_Pesan_Input'), 'Erigo')

WebUI.verifyElementText(findTestObject('MainPage/Pencarian_tidak_ditemukan_Verify'), 'Pencarian tidak ditemukan')