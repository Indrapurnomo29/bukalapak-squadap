...
WebUI.click(findTestObject('CartPage/Cart_Favorite'))

WebUI.click(findTestObject('CartPage/Hapus_Menu'))

WebUI.verifyElementText(findTestObject('CartPage/Barang_telah_dihapus_Pop-Up'), 'Barang telah dihapus.')
