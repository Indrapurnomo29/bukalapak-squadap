...
WebUI.setEncryptedText(findTestObject('Bukalapak.com/PageAccount/Password_Input'), '9nJBMkew2Wc=')

WebUI.click(findTestObject('Bukalapak.com/PageAccount/Login_Button'))

WebUI.verifyElementText(findTestObject('NotificationLogin/Password_yang_kamu_masukkan_salah_Silakan_coba_lagi'), 'Password yang kamu masukkan salah. Silakan coba lagi.')
